...
test.describe('/#/ (XSS via Search Form)', () => {
  ...
  test('should reflect script tag XSS payload', async ({ page }: { page: Page }) => {
  ...
  test('should reflect image onerror XSS payload', async ({ page }: { page: Page }) => {
  ...
  test('should test SVG-based XSS vector', async ({ page }: { page: Page }) => {
  ...
  test('should display search term with HTML entities preserved', async ({ page }: { page: Page }) => {
